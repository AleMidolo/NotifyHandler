...
function operatorReadmeText(sourceCommit) {
  return [
    "NotifyHandler BOOK-012 ADMIRALBET diagnostic runner",
    "===================================================",
    "",
    ...
    "It is locked to the credential-free public origin https://www.admiralbet.it and reuses the reviewed BOOK-012 explorer unchanged.",
    "",
    `Source commit: ${sourceCommit}`,
    "",
    "Requirements:",
    "- Windows x64 workstation with a normal headed desktop session",
    "- outbound DNS/HTTPS access to www.admiralbet.it",
    ...
    "3. Double-click run-admiralbet-validation.cmd or execute it from cmd/PowerShell.",
    ...
    "6. Attach only ExplorerSummary.json to NotifyHandler issue #62 / PR #68. Do not attach browser/session data or other captures.",
    "",
...
export async function buildPortableValidationBundle(options = {}) {
  ...
  await writeFile(join(bundle, "run-admiralbet-validation.cmd"), windowsLauncherText(), "utf8");
