...
function operatorReadmeText(sourceCommit) {
  return [
    ...
    "3. Double-click run-sisal-validation.cmd or execute it from cmd/PowerShell.",
    ...
    "6. Attach only ExplorerSummary.json to NotifyHandler issue #63. Do not attach browser/session data or other captures.",
    "",
