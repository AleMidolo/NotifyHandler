...
- exact hosts are preferred; reviewed suffix rules are explicit, must remain inside the approved bookmaker namespace, must contain the selected bookmaker namespace label, and must not be public suffixes;
